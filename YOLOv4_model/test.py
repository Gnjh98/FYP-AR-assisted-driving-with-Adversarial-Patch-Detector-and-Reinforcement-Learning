...
def test(data,
    ...
    if training:  # called by train.py
        ...
        model = Darknet('cfg/yolov4-pacsp-x').to(device)
    ...
    if not training:
        ...
        dataloader = create_dataloader(path, imgsz, batch_size, 64, single_cls, pad=0.5, rect=True)[0]
    ...
    try:
        ...
        names = load_classes('data/patch.names')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov4-pacsp-x.cfg', help='*.cfg path')
